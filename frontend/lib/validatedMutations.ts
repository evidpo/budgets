...
import { validatedApi } from './apiWithValidation';
import {
  useRealtimeAccounts,
...
// Мутации для работы со счетами с валидацией
 ...
 options?: UseMutationOptions<Account, Error, CreateAccountData>
  ...
  return useMutation<Account, Error, CreateAccountData>({
    mutationFn: async (accountData) => {
      const result = await validatedApi.createAccount(accountData);
...
export const useUpdateAccountMutation = (
  ...
  return useMutation<Account, Error, { id: string; data: UpdateAccountData }>({
    mutationFn: async ({ id, data }) => {
      const result = await validatedApi.updateAccount(id, data);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
...
// Мутации для работы с транзакциями с валидацией
export const useCreateTransactionMutation = (
  ...
  return useMutation<Transaction, Error, CreateTransactionData>({
    mutationFn: async (transactionData) => {
      const result = await validatedApi.createTransaction(transactionData);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
...
// Мутации для работы с бюджетами с валидацией
export const useCreateBudgetMutation = (
  ...
  return useMutation<Budget, Error, CreateBudgetData>({
    mutationFn: async (budgetData) => {
      const result = await validatedApi.createBudget(budgetData);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
...
export const useUpdateBudgetMutation = (
  ...
  return useMutation<Budget, Error, { id: string; data: UpdateBudgetData }>({
    mutationFn: async ({ id, data }) => {
      const result = await validatedApi.updateBudget(id, data);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
...
// Мутации для работы с категориями с валидацией
export const useCreateCategoryMutation = (
  ...
  return useMutation<Category, Error, CreateCategoryData>({
    mutationFn: async (categoryData) => {
      const result = await validatedApi.createCategory(categoryData);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
...
export const useUpdateCategoryMutation = (
  ...
  return useMutation<Category, Error, { id: string; data: UpdateCategoryData }>({
    mutationFn: async ({ id, data }) => {
      const result = await validatedApi.updateCategory(id, data);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
...
// Мутации для работы с долгами с валидацией
export const useCreateDebtMutation = (
  ...
  return useMutation<Debt, Error, CreateDebtData>({
    mutationFn: async (debtData) => {
      const result = await validatedApi.createDebt(debtData);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
...
export const useUpdateDebtMutation = (
  ...
  return useMutation<Debt, Error, { id: string; data: UpdateDebtData }>({
    mutationFn: async ({ id, data }) => {
      const result = await validatedApi.updateDebt(id, data);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
...
// Мутации для работы с правилами с валидацией
export const useCreateRuleMutation = (
  ...
  return useMutation<Rule, Error, CreateRuleData>({
    mutationFn: async (ruleData) => {
      const result = await validatedApi.createRule(ruleData);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
...
export const useUpdateRuleMutation = (
  ...
  return useMutation<Rule, Error, { id: string; data: UpdateRuleData }>({
    mutationFn: async ({ id, data }) => {
      const result = await validatedApi.updateRule(id, data);
      if (result.error) throw new Error(result.error);
      return result.data!;
    },
    onSuccess: (data, variables, context) => {
